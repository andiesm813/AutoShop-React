                ...
                <div className={classes("column-layout group_6")}>
                  ...
                  <div className={classes("row-layout group_8")}>
                    <IgrSelect outlined="false" label="Quantitiy" value={value1} change={(_c, e) => setValue1(e.detail.value)} className={classes("select")}>
                      <IgrSelectItem value="1" key="8a5c3de2-bdc4-49ca-9467-7e9598f18914">
                        <span key={uuid()}>1</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="3edfd36b-0749-4d25-ad4a-0066f209318f">
                        <span key={uuid()}>2</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="c8e476c5-d08f-4b65-ba83-efb28e9c53b5">
                        <span key={uuid()}>3</span>
                      </IgrSelectItem>
                      <IgrSelectItem value="1" key="8b41468b-15f6-4e97-b0d1-240ed1688cc9">
              ...
              <div className={classes("column-layout also-purchased")}>
                ...
                <div className={classes("row-layout group_12")}>
                  <IgrCard elevated="true" className={classes("card")}>
                    ...
                    <IgrCardContent className={classes("body-content")} key={uuid()}>
                      <div className={classes("row-layout group_13")} key={uuid()}>
                        <IgrRating size="small" value={value} change={(_c, e) => setValue(e.detail)} className={classes("rating")}></IgrRating>
                      </div>
                  ...
                  <IgrCard elevated="true" className={classes("card")}>
                    ...
                    <IgrCardContent className={classes("body-content")} key={uuid()}>
                      <div className={classes("row-layout group_13")} key={uuid()}>
                        <IgrRating size="small" value={value2} change={(_c, e) => setValue2(e.detail)} className={classes("rating")}></IgrRating>
                      </div>
                      <h6 className={classes("content_4")} key={uuid()}>
                        <span>$19.90</span>
                      </h6>
                  ...
                  <IgrCard elevated="true" className={classes("card")}>
                    ...
                    <IgrCardContent className={classes("body-content")} key={uuid()}>
                      <div className={classes("row-layout group_13")} key={uuid()}>
                        <IgrRating size="small" value={value3} change={(_c, e) => setValue3(e.detail)} className={classes("rating")}></IgrRating>
                      </div>
                      <h6 className={classes("content_4")} key={uuid()}>
                        <span>$11.00</span>
                      </h6>
                  ...
                  <IgrCard elevated="true" className={classes("card")}>
                    ...
                    <IgrCardContent className={classes("body-content")} key={uuid()}>
                      <div className={classes("row-layout group_13")} key={uuid()}>
                        <IgrRating size="small" value={value4} change={(_c, e) => setValue4(e.detail)} className={classes("rating")}></IgrRating>
                      </div>
                      <h6 className={classes("content_4")} key={uuid()}>
                        <span>$24.50</span>
                      </h6>
