                  ...
                  <IgrList className={classes("list")}>
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Alternator1.jpg" size="large" className={classes("avatar")}></IgrAvatar>
                      </div>
                      <div key={uuid()}>
                    ...
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Depositphotos_91150104_l-2015.jpg" size="large" className={classes("avatar")}></IgrAvatar>
                      </div>
                      <div key={uuid()}>
                        <div className={classes("row-layout group_3")} key={uuid()}>
                    ...
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Depositphotos_114068560_l-2015.jpg" size="large" className={classes("avatar")}></IgrAvatar>
                      </div>
                      <div key={uuid()}>
                        <div className={classes("row-layout group_3")} key={uuid()}>
                          <div className={classes("row-layout group_8")}>
                    ...
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Depositphotos_20993125_l-2015.jpg" size="large" className={classes("avatar")}></IgrAvatar>
                      </div>
                      <div key={uuid()}>
                        <div className={classes("row-layout group_3")} key={uuid()}>
                          <div className={classes("row-layout group_4")}>
                    ...
                    <IgrListItem key={uuid()}>
                      <div style={{display: 'contents'}} slot="start" key={uuid()}>
                        <IgrAvatar src="/src/assets/Depositphotos_12011807_l-2015.jpg" size="large" className={classes("avatar")}></IgrAvatar>
                      </div>
                      <div key={uuid()}>
                        <div className={classes("row-layout group_3")} key={uuid()}>
                          <div className={classes("row-layout group_8")}>
