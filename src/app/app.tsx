import { IgrButton, IgrButtonModule, IgrIconButton, IgrIconButtonModule, IgrRipple, IgrRippleModule } from '@infragistics/igniteui-react';
      ...
      <div className={classes("column-layout master-view-container")}>
        <div className={classes("row-layout group")}>
          ...
          <div className={classes("row-layout group_1")}>
            <IgrButton variant="flat" size="large" clicked={() => navigate(`/all-products`)} className={classes("button")}>
